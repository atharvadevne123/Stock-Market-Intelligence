...
class Article(Base):
    ...
    __table_args__ = (
        Index("ix_articles_ticker_date", "ticker", "published_date"),
    )
...
class Sentiment(Base):
    ...
    __table_args__ = (
        Index("ix_sentiments_ticker_created", "ticker", "created_at"),
    )
...
class BacktestResult(Base):
    ...
    __table_args__ = (
        Index("ix_backtest_ticker_strategy", "ticker", "strategy"),
    )
    ...
    def __repr__(self) -> str:
        return (
            f"<BacktestResult(id={self.id}, ticker={self.ticker!r}, "
