...
class TestSaveArticle:
    def test_returns_article(self, db):
        ...
        result = DatabaseService.save_article(db, "AAPL", "Test", "Content", "Reuters", "https://example.com/test-1")
    ...
    def test_various_tickers(self, db, ticker):
        ...
        result = DatabaseService.save_article(
            db, ticker, "Title", "Content", "Source", f"https://example.com/{ticker.lower()}-unique-123"
        )
